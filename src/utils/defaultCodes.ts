    ...
    codes: [
      {
        ...
        code: `/**\n * Checks if the parentheses in a given string are balanced using a custom Stack class with references approach.\n *\n * @param {string} s - The input string containing parentheses.\n * @returns {boolean} - Returns true if the parentheses are balanced, otherwise false.\n */\nfunction areParenthesesBalanced(s) {\n  const stack = new Stack();\n  const matchingPairs = {\n    ')': '(',\n    ']': '[',\n    '}': '{'\n  };\n\n  for (const char of s) {\n    if (['(', '[', '{'].includes(char)) {\n      stack.push(char);\n    } else if ([')', ']', '}'].includes(char)) {\n      if (stack.pop() !== matchingPairs[char]) {\n        return false;\n      }\n    }\n  }\n\n  return stack.isEmpty();\n}\n\nclass Stack {\n  constructor() {\n    this.top = null;\n    this.bottom = null;\n  }\n\n  isEmpty() {\n    return this.top === null;\n  }\n\n  push(data) {\n    const newNode = { data, next: null };\n    if (this.isEmpty()) {\n      this.top = newNode;\n      this.bottom = newNode;\n      return;\n    }\n    newNode.next = this.top;\n    this.top = newNode;\n  }\n\n  pop() {\n    if (this.isEmpty()) {\n      return null;\n    }\n    const data = this.top.data;\n    this.top = this.top.next;\n    if (this.top === null) {\n      this.bottom = null;\n    }\n    return data;\n  }\n\n  peek() {\n    if (this.isEmpty()) {\n      return null;\n    }\n    return this.top.data;\n  }\n\n  clear() {\n    this.top = null;\n    this.bottom = null;\n  }\n}`
      },
      {
        languageId: 'javascript',
        code: `/**\n * Checks if the parentheses in a given string are balanced using a custom Stack class with array approach.\n *\n * @param {string} s - The input string containing parentheses.\n * @returns {boolean} - Returns true if the parentheses are balanced, otherwise false.\n */\nfunction areParenthesesBalanced(s) {\n  const stack = new Stack();\n  const matchingPairs = {\n    ')': '(',\n    ']': '[',\n    '}': '{'\n  };\n\n  for (const char of s) {\n    if (['(', '[', '{'].includes(char)) {\n      stack.push(char);\n    } else if ([')', ']', '}'].includes(char)) {\n      if (stack.pop() !== matchingPairs[char]) {\n        return false;\n      }\n    }\n  }\n\n  return stack.isEmpty();\n}\n\nclass Stack {\n  #items;\n\n  constructor() {\n    this.#items = [];\n  }\n\n  push(item) {\n    this.#items.push(item);\n  }\n\n  pop() {\n    if (this.isEmpty()) throw new Error("Stack is empty");\n    return this.#items.pop();\n  }\n\n  peek() {\n    if (this.isEmpty()) throw new Error("Stack is empty");\n    return this.#items[this.#items.length - 1];\n  }\n\n  isEmpty() {\n    return this.#items.length === 0;\n  }\n\n  clear() {\n    this.#items = [];\n  }\n}`
      },
      {
    ...
    testCases: [
      {
        id: '1637655295892',
        title: 'Test Case',
        testCase: `areParenthesesBalanced('()((())()))()[]{}{{{}}}()');`
      },
      {
        id: '1637655295893',
        title: 'Test Case',
